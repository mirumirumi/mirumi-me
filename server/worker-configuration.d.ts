/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: ad6ffade3ccdcd6ff87c86be34dc0c2e)
// Runtime types generated with workerd@1.20260804.1 2026-08-12 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	X_POST_CACHE?: KVNamespace;
	BACKUP?: R2Bucket;
	MIRUMI_ME_PV?: AnalyticsEngineDataset;
	APP_ENV?: "dev" | "prd";
	ACCESS_AUD?: "84cc688b6267419444da69a5a070b1043a8e1de0cf4c072d5affcd4ec779b239";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ACCESS_AUD" | "ACCESS_TEAM_DOMAIN" | "AWS_REGION" | "SITE_BUCKET_NAME" | "CLOUDFRONT_DISTRIBUTION_ID" | "NOTION_TOKEN" | "NOTION_WEBHOOK_SECRET" | "TURNSTILE_SECRET" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "XAI_API_KEY">> {}
}
