/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 8f8482d5566a785b5a0ee163d2fd61bd)
// Runtime types generated with workerd@1.20260804.1 2026-08-24 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	CONTENT_CACHE?: KVNamespace;
	BACKUP?: R2Bucket;
	MIRUMI_ME_PV?: AnalyticsEngineDataset;
	RATE_LIMITER_60_PER_MINUTE?: RateLimit;
	RATE_LIMITER_COMMENTS?: RateLimit;
	APP_ENV?: "dev" | "prd";
	...
	NOTION_POSTS_DATA_SOURCE_ID?: "3c065425-ad40-811a-b50b-000b9271df2c" | "399e5acd-5762-442b-a3f5-be983498d926";
	NOTION_PAGES_DATA_SOURCE_ID?: "dc065425-ad40-8391-8e64-87fc27e80a3a" | "53765425-ad40-828e-976a-0789d64d4dee";
	NOTION_INTERNAL_STATE_PROPERTY_ID?: "o=BU";
	NOTION_COMMENTS_DATA_SOURCE_ID?: "3d365425-ad40-8100-9705-000ba2e7afec" | "201f8de6-3bca-4731-b19e-592fc87af528";
	...
	WORKERS_API_ORIGIN?: "https://mirumi-me-dev.v2p04rubfuwnvttj.workers.dev" | "https://mirumi-me-prd.v2p04rubfuwnvttj.workers.dev";
	FRONTEND_ORIGIN?: "https://d3694gpnjd4x49.cloudfront.net" | "https://mirumi.me";
	AMAZON_CREATORS_MARKETPLACE?: "www.amazon.co.jp";
	AMAZON_ASSOCIATE_TAG?: "milmemo-22";
	AMAZON_CREATORS_CREDENTIAL_VERSION?: "3.3";
	XAI_MODEL?: "grok-4.6";
	AWS_REGION?: "ap-northeast-1";
	SITE_BUCKET_NAME?: "mirumime-dev-mirumi-me" | "mirumime-prd-mirumi-me";
	BACKUP_BUCKET_NAME?: "mirumime-dev-backup" | "mirumime-prd-backup";
	MEDIA_BUCKET_NAME?: "mirumime-prd-mirumi-media";
	CLOUDFRONT_DISTRIBUTION_ID?: "E16GU2ZPNLT91U" | "E1UPWIMHFP5TEC";
	...
	COMMENT_DIGEST_RECIPIENT?: string;
	AMAZON_CARD_SIGNING_SECRET?: string;
	AMAZON_CREATORS_CREDENTIAL_ID?: string;
	AMAZON_CREATORS_CREDENTIAL_SECRET?: string;
	THUMBNAIL_FUNCTION_URL?: string;
	AWS_ACCESS_KEY_ID?: string;
	AWS_SECRET_ACCESS_KEY?: string;
	XAI_API_KEY?: string;
	BUILD_CONTAINER?: DurableObjectNamespace<import("./src/main").BuildContainer>;
	PUBLISH_WORKFLOW?: Workflow<Parameters<import("./src/main").PublishWorkflow['run']>[0]['payload']>;
	COMMENT_REFRESH_WORKFLOW?: Workflow<Parameters<import("./src/main").CommentRefreshWorkflow['run']>[0]['payload']>;
	BACKUP_WORKFLOW?: Workflow<Parameters<import("./src/main").BackupWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ACCESS_PREVIEW_AUD" | "ACCESS_ADMIN_AUD" | "ACCESS_LOCAL_DEV_AUD" | "ACCESS_TEAM_DOMAIN" | "NOTION_POSTS_DATA_SOURCE_ID" | "NOTION_PAGES_DATA_SOURCE_ID" | "NOTION_INTERNAL_STATE_PROPERTY_ID" | "NOTION_COMMENTS_DATA_SOURCE_ID" | "NOTION_COMMENT_STATE_PROPERTY_ID" | "NOTION_COMMENT_CONTENT_PROPERTY_ID" | "NOTION_COMMENT_AUTHOR_PROPERTY_ID" | "NOTION_COMMENT_PARENT_PROPERTY_ID" | "WORKERS_API_ORIGIN" | "FRONTEND_ORIGIN" | "AMAZON_CREATORS_MARKETPLACE" | "AMAZON_ASSOCIATE_TAG" | "AMAZON_CREATORS_CREDENTIAL_VERSION" | "XAI_MODEL" | "AWS_REGION" | "SITE_BUCKET_NAME" | "BACKUP_BUCKET_NAME" | "MEDIA_BUCKET_NAME" | "CLOUDFRONT_DISTRIBUTION_ID" | "SES_REGION" | "COMMENT_DIGEST_SENDER" | "NOTION_TOKEN" | "NOTION_WEBHOOK_SECRET" | "TURNSTILE_SECRET" | "SES_ACCESS_KEY_ID" | "SES_SECRET_ACCESS_KEY" | "COMMENT_DIGEST_RECIPIENT" | "AMAZON_CARD_SIGNING_SECRET" | "AMAZON_CREATORS_CREDENTIAL_ID" | "AMAZON_CREATORS_CREDENTIAL_SECRET" | "THUMBNAIL_FUNCTION_URL" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "XAI_API_KEY">> {}
}
