...
export function justAnswer() {
  ...
  commentMoreButton?.addEventListener("click", async () => {
    ...
    const donation = `<div id="content"><div class="box-common box-rewrite" style="margin: 0;">
...
<p><a href="https://amzn.to/4n51Gqn" target="_blank" rel="nofollow" onclick="gtag('event','click',{'event_category':'asp','event_label':'ジャストアンサー_post-scripts_テキスト(https://amzn.to/4n51Gqn)'})">https://amzn.to/4n51Gqn</a></p>
