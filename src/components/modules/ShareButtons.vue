<template>
  <div class="share_buttons" aria-hidden="true">
    <div class="share_button">
      <a :href="`https://twitter.com/intent/tweet?text=${encodeURI(title)} - みるめも @${encodeURI(appConfig.twitterName)}&amp;url=${encodeURI(appConfig.siteFullPath + '/' + slug)}`" target="_blank" rel="nofollow noopener noreferrer">
    ...
    <div class="share_button">
      <a :href="`https://b.hatena.ne.jp/entry/s/${encodeURI(appConfig.siteDomain + '/' + slug)}`" target="_blank" rel="nofollow noopener noreferrer">
    ...
    <div class="share_button">
      <a :href="`https://feedly.com/i/discover/sources/search/feed/${encodeURI(appConfig.siteFullPath)}`" target="_blank" rel="nofollow noopener noreferrer">
    ...
    <div class="share_button">
      <a :href="`https://getpocket.com/edit?url=${encodeURI(appConfig.siteFullPath + '/' + slug)}`" target="_blank" rel="nofollow noopener noreferrer">
