<template>
  <div class="share_buttons">
    <div class="share_button">
      ...
      <span class="snsbadge" style="color: #8cbadb;">
        {{ counts.twitter }}
      </span>
    </div>
    <div class="share_button">
      ...
      <span class="snsbadge" style="color: #72bbe5;">
        {{ counts.hatebu }}
      </span>
    </div>
    <div class="share_button">
      ...
      <span class="snsbadge" style="color: #9fcc95;">
        {{ counts.feedly }}
      </span>
    </div>
    <div class="share_button">
      ...
      <span class="snsbadge" style="color: #e88992;">
        {{ counts.pocket }}
      </span>
    </div>
    <div class="share_button">
      <button class="like_button" aria-label="いいね">
...
defineProps<{
  ...
  counts: {
    ...
    hatebu: string | number,
    feedly: string | number,
