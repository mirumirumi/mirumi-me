      ...
      <NuxtLink :to="`/${p.slug}/`" class="post page_transition_target">
        ...
        <div class="meta">
          <div class="created_at">
            ...
            <time :datetime="p.publishedAt">{{ friendlyDatetime(p.publishedAt) }}</time>
          </div>
          <div v-if="p.updatedAt && p.publishedAt !== p.updatedAt" class="updated_at">
            <PartsSvgIcon
