...
def main() -> None:
    ...
    save_file("app/.output/public/", "feed.xml", res_main.text.replace("mirumi.in", "mirumi.me"))
    ...
    save_file("app/.output/public/", "feed-comments.xml", res_comment.text.replace("mirumi.in", "mirumi.me"))
